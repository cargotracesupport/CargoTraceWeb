...
export default function LoginForm() {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      // Replace (not push) so /login leaves the history — pressing Back after
      // signing in won't return to the login screen. Full navigation also sends
      // the auth cookie; `loading` stays true so the spinner holds till paint.
